...
class App {
  ...
  _renderWorkout(workout) {
    ...
    this._closeWorkout(e);
}
    _closeWorkout(e){

        const workoutEl = e.target.closest('.workout');
        closeButton.forEach((_, i) => closeButton[i].addEventListener('click', function(e){
            console.log(e);
        }));
    }
  _moveToPopup(e) {
  ...
  _getLocalStorage() {
    ...
    this.#keysMyStorage = Object.keys(localStorage);
